  ...
  return (
    <div className={`min-h-screen relative overflow-hidden ${cinzel.className}`}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-[-5]">
        ...
        <div className="absolute top-1/4 -right-20 w-60 h-60 bg-[#d4af37] opacity-10 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: "2s" }} />
        <div className="absolute -bottom-20 left-1/3 w-80 h-80 bg-[#d4af37] opacity-10 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: "4s" }} />
      </div>

      {/* Rotating feather/icon */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0 opacity-5">
        <svg className="w-96 h-96 text-[#d4af37] animate-spin-slow" style={{ animationDuration: "60s" }} viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="relative max-w-3xl w-full backdrop-blur-xl bg-white/80 border border-[#d4af37]/20 rounded-xl p-8 md:p-10 shadow-[0_0_25px_rgba(212,175,55,0.15)] animate-fade-in">
          ...
          <div className="space-y-8">
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              <p>
                Welcome to the official website of TALWAR Constructions & Interior&apos;s (&quot;we,&quot; &quot;our,&quot; &quot;us&quot;).
                By accessing or using our website and services, you agree to comply with and be bound by the following Terms & Conditions.
                Please read them carefully.
              </p>

              <h2 className="text-xl font-semibold mt-8 mb-4 text-[#d4af37]">1. General Information</h2>
              <p>
                TALWAR Constructions & Interior&apos;s is a full-scale construction and interior design company specializing in property
                development, civil contracting, residential & commercial interiors, and custom furniture solutions. All content, designs, and
                information on this website are intended for informational purposes only.
              </p>

              <h2 className="text-xl font-semibold mt-8 mb-4 text-[#d4af37]">2. Acceptance of Terms</h2>
              <p>
                By using our website, you confirm that you have read, understood, and agree to these Terms & Conditions. If you do not agree,
              ...
              <p>All services are subject to project-specific contracts and agreements.</p>

              <h2 className="text-xl font-semibold mt-8 mb-4 text-[#d4af37]">4. Intellectual Property Rights</h2>
              <p>
                All designs, concepts, text, graphics, images, logos, and other materials displayed on this website are the exclusive property
                of TALWAR Constructions & Interior&apos;s unless otherwise stated.
              </p>
              <p>You may not reproduce, copy, distribute, or use any content without our prior written consent.</p>

              <h2 className="text-xl font-semibold mt-8 mb-4 text-[#d4af37]">5. Project Estimates & Payments</h2>
              <p>Any quotations or cost estimates provided by us are valid for a limited time and subject to change without notice.</p>
              <p>Payment terms will be outlined in the individual project contract.</p>
              <p>Delays in payment may result in a pause or termination of services.</p>
              ...
              <p>While we aim to deliver high-quality work, TALWAR Constructions & Interior&apos;s will not be held liable for:</p>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <p>
                We reserve the right to update or change these Terms & Conditions at any time without prior notice. Changes will be posted on
                our website.
              </p>

              <h2 className="text-xl font-semibold mt-8 mb-4 text-[#d4af37]">9. Governing Law</h2>
              <p>
                These Terms & Conditions shall be governed and interpreted in accordance with the laws of India. Any disputes shall be subject
